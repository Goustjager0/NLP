...
def train(
    ...
    def preprocess_function(examples):
        ...
        for i in range(len(examples["answers"])):
            if len(examples["answers"][i]["text"]) == 0 or len(examples["answers"][i]["answer_start"]) == 0:
                # If no answer, use CLS token as placeholder
                ...
                # Find the token span that matches
    ...
    def generate_and_tokenize_prompt(data_point):
        ...
        tokenized_full_prompt = preprocess_function(data_point)
